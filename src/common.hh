...
#define CONST_ARRAY_INIT_REGISTERS {r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11}
...
#define PRELLOC_REGISTER (r11)
#define DELLOC_REGISTER (r11)
#define GLOBAL_ALLOC_LR_TEMP (r12)
