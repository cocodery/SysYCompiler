...
#include "extlibs/antlr4-runtime.h"
...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitNumber1(SysYParser::Number1Context *context) = 0;

    virtual antlrcpp::Any visitNumber2(SysYParser::Number2Context *context) = 0;
